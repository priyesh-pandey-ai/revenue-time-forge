      ...
      <div className="container relative z-10 px-6 text-center">
        <div className="mx-auto max-w-4xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-2 backdrop-blur-sm animate-fade-in">
            ...
            <span className="text-sm font-semibold text-primary">Transform Your Career in 6 Weeks</span>
          </div>
          
          <h1 className="mb-6 text-5xl font-bold leading-tight text-foreground md:text-7xl animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Step Into the <span className="text-gradient animate-glow">Career Time Machine</span> for Revenue Leadership
          </h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <Button 
              size="lg" 
              className="group relative bg-gradient-primary text-background font-semibold shadow-[0_0_30px_rgba(139,92,246,0.3)] hover:shadow-[0_0_50px_rgba(139,92,246,0.5)] transition-all duration-300 hover-scale"
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-primary text-foreground hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover-scale font-semibold"
        ...
        >
          {stats.map((stat, idx) => (
            <div 
              key={idx} 
              className={`group rounded-lg border border-border/50 bg-card p-6 backdrop-blur-sm transition-all duration-500 hover:border-neon-blue/50 hover:shadow-[0_0_30px_rgba(56,189,248,0.2)] hover-scale ${
